...
function (t, e) {
        ...
        if (!(D(t, r) < O(n, s) || O(t, r) > D(n, s) || D(e, i) < O(a, o) || O(e, i) > D(a, o))) {
            ...
            if (u) {
                var c = l / u,
                    ...
                    p = +c.toFixed(2),
                    d = +f.toFixed(2);
                if (!(p < +O(t, r).toFixed(2) || p > +D(t, r).toFixed(2) || p < +O(n, s).toFixed(2) || p > +D(n, s).toFixed(2) || d < +O(e, i).toFixed(2) || d > +D(e, i).toFixed(2) || d < +O(a, o).toFixed(2) || d > +D(a, o).toFixed(2))) return {
                    x: c,
                    y: f
                }
            }
    ...
    _.safari = "Apple Computer, Inc." == navigator.vendor && (Ve && Ve[1] < 4 || "iP" == navigator.platform.slice(0, 2)) || "Google Inc." == navigator.vendor && Ve && Ve[1] < 8 ? function () {
                        ...
                        if (a[t](d)) {
                            ...
                            case "clip-rect":
                                ...
                                if (4 == B.length) {
                                    ...
                                    var S = v("clipPath"),
                                        T = v("rect");
                                    S.id = r.createUUID(), v(T, {
                                        x: B[0],
                                        y: B[1],
                                        width: B[2],
                                        height: B[3]
                                    }), S.appendChild(T), i.paper.defs.appendChild(S), v(l, {
                                        "clip-path": "url(#" + S.id + ")"
                                    }), i.clip = T
                                }
                                if (!g) {
                                    ...
                                    if (A) {
                                        var N = r._g.doc.getElementById(A.replace(/(^url\(#|\)$)/g, c));
                            ...
                            case "stroke-dasharray":
                                ...
                                break;
                            case "fill":
                                var E = e(g).match(r._ISURL);
                                if (E) {
                                    S = v("pattern");
                                    var L = v("image");
                                    S.id = r.createUUID(), v(S, {
                                        x: 0,
                                        y: 0,
                                    ...
                                    }(S), i.paper.defs.appendChild(S), v(l, {
                                        fill: "url(#" + S.id + ")"
                            ...
                            case "stroke":
                                M = r.getRGB(g), l.setAttribute(d, M.hex), "stroke" == d && M[t]("opacity") && v(l, {
                            ...
                            case "fill-opacity":
                                if (u.gradient) {
                                    P = r._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c)), P && (z = P.getElementsByTagName("stop"), v(z[z.length - 1], {
                                        "stop-opacity": g
                                    }));
                                    break
                                }
